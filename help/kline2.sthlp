{smcl}
{* 2018年9月17日}{...}
{cmd:help kline2}{right: }
{hline}

{title:简介}

{p2colset 5 25 27 2}{...}
{p2col:{hi: kline2} {hline 2}}调用ECharts绘制蜡烛图。
{p_end}
{p2colreset}{...}
...
{p 8 18 2}
{cmdab:kline2} {it: code}{cmd:,}
[{opt s:tart}{cmd:(}{it:string}{cmd:)} {opt e:nd}{cmd:(}{it:string}{cmd:)} {opt s:tock} {opt i:ndex} {opt sch:eme}{cmd:(}{it:string}{cmd:)}]
...
{phang} {bf: {opt sch:eme}(}{it:string}{bf:)}: 控制绘图的主题，有dark/roma/vintage/macarons/infographic/shine六种可选，默认vintage主题。{p_end}

{title:示例}
{phang}
{stata `"kline2 1, start(20180101) end(20180701)"'}
{p_end}
{phang}
{stata `"kline2 1, start(20180101) end(20180701) index"'}
{p_end}
